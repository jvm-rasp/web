...
type RaspHost struct {
	...
	TotalMem              string `gorm:"type:int(11);comment:'实例总内存,单位GB'" json:"totalMem"`
	CpuCounts             string `gorm:"type:int(11);comment:'实例逻辑cpu数量'" json:"cpuCounts"`
	FreeDisk              string `gorm:"type:int(11);comment:'实例可用磁盘容量,单位GB'" json:"freeDisk"`
