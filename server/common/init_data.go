...
func InitData() {
	...
	menus := []model.Menu{
		...
		{
			Model:     gorm.Model{ID: configId + 2},
			Name:      "Detail",
			Title:     "策略详情",
			Hidden:    1,
			Icon:      &listIcon,
